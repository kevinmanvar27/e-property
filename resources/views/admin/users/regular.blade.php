...
<div class="page-content">
        ...
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 p-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Regular Users</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
    ...
    <div class="row">
        <div class="col-xl-12 mx-auto">
            <h6 class="mb-0 text-uppercase">Regular Users</h6>
            <hr/>
            <div class="card">
                <div class="card-body">
                        ...
                        <table class="table table-striped table-bordered" id="usersTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($user->photo)
                                            <img src="{{ asset('storage/' . $user->photo) }}" alt="{{ $user->name }}" class="user-avatar rounded-circle" width="40" height="40">
                                        @else
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add New Regular User</h5>
...
<div class="modal fade" id="editUserModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Edit Regular User</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
...
<script>
    ...
    $(document).on('change', '.status-toggle', function() {
        ...
        $.ajax({
            url: '{{ url("/admin/users/regular") }}/' + id + '/toggle-status',
            type: 'PATCH',
            data: {
                status: status,
                _method: 'PATCH'
    ...
    $(document).on('click', '.delete-user', function() {
        ...
        if (confirm('Are you sure you want to delete this user?')) {
            $.ajax({
                url: '{{ url("/admin/users/regular") }}/' + id,
                type: 'DELETE',
                data: {},
                headers: {
                    'X-Requested-With': 'XMLHttpRequest'
