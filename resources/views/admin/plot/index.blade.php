...
<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
    ...
    <div class="ms-auto">
        <div class="btn-group">
            <a href="{{ route('plot.create') }}" class="btn btn-primary" aria-label="Add New Plot">Add New Plot</a>
        </div>
    </div>
</div>
...
<div class="card">
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-striped table-bordered" id="plotTable" aria-label="Plot List">
                <thead>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center">
                                <a href="{{ route('plot.show', $property->id) }}" class="btn btn-sm btn-info me-2" aria-label="View Plot Details">View</a>
                                <a href="{{ route('plot.edit', $property->id) }}" class="btn btn-sm btn-warning me-2" aria-label="Edit Plot">Edit</a>
                                <button type="button" class="btn btn-sm btn-danger delete-btn" data-id="{{ $property->id }}" aria-label="Delete Plot">Delete</button>
                            </div>
                        </td>
                    </tr>
                    @endforeach
...
$(document).ready(function() {
    ...
    $(document).on('change', '.status-select', function() {
        var id = $(this).data('id');
        var status = $(this).val();
        var url = '{{ url("admin/plot") }}/' + id + '/update-status';
        var select = $(this);
