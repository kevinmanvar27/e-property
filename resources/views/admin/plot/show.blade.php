    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('plot.index') }}" aria-label="Plot List">Plot List</a>
                </li>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="d-flex justify-content-between align-items-center p-4 border-bottom">
                    ...
                    <div>
                        <a href="{{ route('plot.index') }}" class="btn btn-light btn-sm me-2">
                ...
                <div class="row g-0 border-bottom">
                    ...
                    <div class="col-4 col-md-4 text-center p-3 border-end">
                        ...
                        <div class="mt-2">
                            <h6 class="mb-0">
                                {{ (is_array($property->amenities) ? count($property->amenities) : 0) + (is_array($property->landTypes) ? count($property->landTypes) : 0) }}
                            </h6>
