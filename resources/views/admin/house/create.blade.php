    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item active" aria-current="page">Add New House</li>
            </ol>
        </nav>
    </div>
</div>
...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Add New House Record</h5>
    </div>
    <div class="card-body">
        <form id="shop-form" enctype="multipart/form-data">
            ...
            <div class="section-card mb-4">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control" id="bhk" name="bhk" min="0">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="hidden" id="is_apartment" name="is_apartment" value="no">
                        <input type="hidden" id="is_tenament" name="is_tenament" value="no">
                    </div>
                    <div class="col-md-6" id="floor_question_container" style="display: none;">
                        <label id="floor_question_label" class="form-label"></label>
                        <input type="number" class="form-control" id="floor_value" name="floor_value" min="0">
                        <input type="hidden" id="apartment_floor" name="apartment_floor">
                        <input type="hidden" id="tenament_floors" name="tenament_floors">
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end">
                <a href="{{ route('house.index') }}" class="btn btn-secondary me-2">Cancel</a>
                <button type="submit" class="btn btn-primary">Save House Record</button>
            </div>
        </form>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Set initial values based on hidden inputs
