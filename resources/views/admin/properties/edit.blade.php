...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Edit Property Record</h5>
    </div>
    <div class="card-body">
        <form id="property-form" enctype="multipart/form-data" aria-label="Edit Property Form">
            @csrf
            @method('PUT')
            ...
            <div class="section-card mb-4">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="owner_name" name="owner_name" value="{{ $property->owner_name }}" required aria-describedby="owner_name_error">
                        <div class="invalid-feedback" id="owner_name_error" role="alert"></div>
                    </div>
                    <div class="col-md-6">
                        <label for="contact_number" class="form-label">Contact Number</label>
                        <input type="text" class="form-control" id="contact_number" name="contact_number" value="{{ $property->contact_number }}" maxlength="15">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <select class="form-select" id="property_type" name="property_type" required aria-describedby="property_type_error">
                            ...
                            <option value="land_jamin" {{ $property->property_type == 'land_jamin' ? 'selected' : '' }}>Land/Jamin</option>
                            ...
                            <option value="shade" {{ $property->property_type == 'shade' ? 'selected' : '' }}>Shade</option>
            ...
            <div class="section-card mb-4">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="first_line" name="first_line" value="{{ $property->first_line }}" required>
                        <div class="invalid-feedback" id="first_line_error"></div>
                    </div>
                    <div class="col-md-6">
                        <label for="second_line" class="form-label">Address Second Line</label>
                        <input type="text" class="form-control" id="second_line" name="second_line" value="{{ $property->second_line }}">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="village" name="village" value="{{ $property->village }}" required>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select" id="state_id" name="state_id" required>
                            ...
                            <option value="{{ $stateId }}" {{ $property->state_id == $stateId ? 'selected' : '' }}>{{ $stateName }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select" id="district_id" name="district_id" required>
                            ...
                            <option value="{{ $districtId }}" {{ $property->district_id == $districtId ? 'selected' : '' }}>{{ $districtName }}</option>
                            @endforeach
                        </select>
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <select class="form-select" id="taluka_id" name="taluka_id">
                            ...
                            <option value="{{ $talukaId }}" {{ $property->taluka_id == $talukaId ? 'selected' : '' }}>{{ $talukaName }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-4">
                        <label for="pincode" class="form-label">Pincode <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="pincode" name="pincode" value="{{ $property->pincode }}" required maxlength="6">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select" id="country_id" name="country_id" required>
                            ...
                            <option value="{{ $countryId }}" {{ $property->country_id == $countryId ? 'selected' : '' }}>{{ $countryName }}</option>
                            @endforeach
                        </select>
            ...
            <div class="section-card mb-4">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <div class="mt-2">
                            <button type="button" class="btn btn-sm btn-info" onclick="viewDocument('{{ asset('assets/documents/' . $property->document_7_12) }}')" aria-label="View Document">View Document</button>
                        </div>
                        @endif
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="mt-2">
                            <button type="button" class="btn btn-sm btn-info" onclick="viewDocument('{{ asset('assets/documents/' . $property->document_8a) }}')">View Document</button>
                        </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="section-card mb-4">
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <input type="file" class="form-control" id="photos" name="photos[]" multiple accept=".jpg,.jpeg,.png" aria-describedby="photos_size photos_error">
                        ...
                        <div class="mt-3">
                            ...
                            <div class="row" id="photo-gallery">
                                ...
                                <div class="col-md-3 mb-3 photo-item" data-index="{{ $index }}" data-position="{{ $photo['position'] ?? $index }}">
                                    <div class="card">
                                        <img src="{{ asset('assets/photos/' . $photo['photo_path']) }}" class="card-img-top" alt="Property Photo" style="height: 150px; object-fit: cover; cursor: pointer;" onclick="viewImage('{{ asset('assets/photos/' . $photo['photo_path']) }}')">
                                        <div class="card-body p-2">
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <button type="button" class="btn btn-sm btn-delete" onclick="deletePhoto({{ $property->id }}, {{ $index }})" title="Delete"><i class='bx bx-trash'></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <div class="d-flex flex-wrap" id="land-types-container">
                            ...
                            <div class="form-check me-3 mb-2">
                                <input class="form-check-input" type="checkbox" name="land_types[]" value="{{ $landType->id }}" id="land_type_{{ $landType->id }}" {{ in_array($landType->id, $selectedLandTypes) ? 'checked' : '' }}>
            ...
            <div class="section-card mb-4">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6" id="issue_description_container" style="{{ $property->any_issue == 'Yes' ? 'display: block;' : 'display: none;' }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6" id="family_issue_description_container" style="{{ $property->family_issue == 'Yes' ? 'display: block;' : 'display: none;' }}">
            ...
            <div class="section-card mb-4">
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <textarea class="form-control" id="additional_notes" name="additional_notes" rows="3">{{ $property->additional_notes }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex justify-content-end">
                ...
                <button type="submit" class="btn btn-primary">Update Property Record</button>
            </div>
        </form>
    </div>
</div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <img id="modal-image" src="" alt="Property Photo" class="img-fluid">
            </div>
        </div>
    </div>
</div>
...
$(document).ready(function() {
    ...
    window.viewDocument = function(documentUrl) {
        $('#modal-document').attr('src', documentUrl);
        $('#documentViewerModal').modal('show');
    };
    
    // Delete photo function
    window.deletePhoto = function(propertyId, photoIndex) {
        if (confirm('Are you sure you want to delete this photo?')) {
            $.ajax({
                url: '{{ url("admin/properties") }}/' + propertyId + '/photos/' + photoIndex,
                type: 'DELETE',
                data: {
                    '_token': '{{ csrf_token() }}'
                },
                success: function(response) {
                    if (response.success) {
                        ...
                        $('.photo-item[data-index="' + photoIndex + '"]').remove();
    ...
    $('#property-form').submit(function(e) {
        ...
        $.ajax({
            url: '{{ route("land-jamin.update", $property->id) }}',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            success: function(response) {
                ...
                if (response.success) {
                    toastr.success('Property record updated successfully in ' + duration.toFixed(2) + 'ms.');
            ...
            error: function(xhr) {
                if (xhr.status === 422 && xhr.responseJSON && xhr.responseJSON.errors) {
                    ...
                    toastr.error('An error occurred while updating the property record.');
                }
            },
            complete: function() {
