    ...
    <div class="ps-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 p-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('land-jamin.index') }}">Land List</a></li>
...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0">Edit Land Record</h5>
    </div>
    <div class="card-body">
        <form id="land-form" enctype="multipart/form-data">
            ...
            <div class="d-flex justify-content-end">
                ...
                <button type="submit" class="btn btn-primary">Update Land Record</button>
            </div>
        </form>
    </div>
</div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="add-land-type-form">
                    @csrf
                    <div class="mb-3">
                        <label for="land_type_name" class="form-label">Name <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="land_type_name" name="name" required>
                        <div class="invalid-feedback" id="land_type_name_error"></div>
                    </div>
                    <div class="mb-3">
                        <label for="land_type_description" class="form-label">Description</label>
                        <textarea class="form-control" id="land_type_description" name="description" rows="3"></textarea>
                    </div>
...
document.getElementById('land-form').addEventListener('submit', function(e) {
    ...
    // Validate pincode - allow up to 10 characters as per server validation
    const pincode = document.getElementById('pincode').value;
    if (pincode.length > 10) {
        document.getElementById('pincode_error').textContent = 'Pincode must be no more than 10 characters';
    ...
    .catch(error => {
        ...
        const generalError = document.createElement('div');
        generalError.className = 'alert alert-danger';
        generalError.textContent = 'An error occurred while updating the land record. Please check that your files are under 100MB and try again.';
        generalError.style.marginBottom = '20px';
