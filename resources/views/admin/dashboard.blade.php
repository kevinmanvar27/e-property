        ...
        <div class="table-responsive">
            <table class="table align-middle mb-0">
                ...
                <tbody>
                    <tr>
                        <td>Headphone GL</td>
                        <td><img src="assets/images/products/1.png" class="product-img-2" alt="product img"></td>
                        <td>#9405822</td>
                    ...
                    <tr>
                        <td>Hand Watch</td>
                        <td><img src="assets/images/products/2.png" class="product-img-2" alt="product img"></td>
                        <td>#8304620</td>
                    ...
                    <tr>
                        <td>Wall Clock</td>
                        <td><img src="assets/images/products/3.png" class="product-img-2" alt="product img"></td>
                        <td>#4736890</td>
                    ...
                    <tr>
                        <td>Locker</td>
                        <td><img src="assets/images/products/4.png" class="product-img-2" alt="product img"></td>
                        <td>#3856720</td>
                        <td><span class="badge bg-gradient-quepal text-white shadow-sm w-100">Paid</span></td>
                        <td>$1150.00</td>
                        <td>
                    ...
                    <tr>
                        <td>LED Lights</td>
                        <td><img src="assets/images/products/5.png" class="product-img-2" alt="product img"></td>
                        <td>#6728421</td>
                        <td><span class="badge bg-gradient-blooker text-white shadow-sm w-100">Pending</span></td>
                        <td>$1389.00</td>
                        <td>
