...
<body>
  <div class="email-wrapper">
    ...
    <div class="content">
      ...
      <div class="note">
        <strong>Security Tip:</strong> For your protection, please ensure you're using a strong password that includes a mix of uppercase and lowercase letters, numbers, and symbols.
      </div>
    </div>
