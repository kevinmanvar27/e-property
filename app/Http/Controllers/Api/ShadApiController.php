...
class ShadApiController extends BasePropertyApiController
{
    ...
    /**
     * @OA\Get(
     *      path="/api/shad/{property}/states/{countryId}",
    ...
    /**
     * @OA\Get(
     *      path="/api/shad/{property}/districts/{stateId}",
    ...
    /**
     * @OA\Get(
     *      path="/api/shad/{property}/talukas/{districtId}",
    ...
    /**
     * @OA\Post(
     *      path="/api/shad/{property}/amenities",
    ...
    /**
     * @OA\Post(
     *      path="/api/shad/{property}/land-types",
    ...
    /**
     * @OA\Post(
     *      path="/api/shad/{property}/photo-positions",
    ...
    /**
     * @OA\Delete(
     *      path="/api/shad/{property}/photos/{photoIndex}",
    ...
    /**
     * @OA\Patch(
     *      path="/api/shad/{property}/update-status",
