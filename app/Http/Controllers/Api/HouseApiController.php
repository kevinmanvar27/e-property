...
class HouseApiController extends BasePropertyApiController
{
    protected $propertyType = 'house';
    protected $resourceName = 'house';
    ...
    /**
     * @OA\Get(
     *      path="/api/house/{property}/states/{countryId}",
    ...
    /**
     * @OA\Get(
     *      path="/api/house/{property}/districts/{stateId}",
    ...
    /**
     * @OA\Get(
     *      path="/api/house/{property}/talukas/{districtId}",
    ...
    /**
     * @OA\Post(
     *      path="/api/house/{property}/amenities",
    ...
    /**
     * @OA\Post(
     *      path="/api/house/{property}/land-types",
    ...
    /**
     * @OA\Post(
     *      path="/api/house/{property}/photo-positions",
    ...
    /**
     * @OA\Delete(
     *      path="/api/house/{property}/photos/{photoIndex}",
    ...
    /**
     * @OA\Patch(
     *      path="/api/house/{property}/update-status",
