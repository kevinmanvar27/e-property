...
class ShopApiController extends BasePropertyApiController
{
    protected $propertyType = 'shop';
    ...
    /**
     * @OA\Get(
     *      path="/api/shop/{property}/states/{countryId}",
    ...
    /**
     * @OA\Get(
     *      path="/api/shop/{property}/districts/{stateId}",
    ...
    /**
     * @OA\Get(
     *      path="/api/shop/{property}/talukas/{districtId}",
    ...
    /**
     * @OA\Post(
     *      path="/api/shop/{property}/amenities",
    ...
    /**
     * @OA\Post(
     *      path="/api/shop/{property}/land-types",
    ...
    /**
     * @OA\Post(
     *      path="/api/shop/{property}/photo-positions",
    ...
    /**
     * @OA\Delete(
     *      path="/api/shop/{property}/photos/{photoIndex}",
    ...
    /**
     * @OA\Patch(
     *      path="/api/shop/{property}/update-status",
