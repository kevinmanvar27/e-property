...
class LandJaminApiController extends BasePropertyApiController
{
    ...
    /**
     * @OA\Get(
     *      path="/api/land-jamin/{property}/states/{countryId}",
    ...
    /**
     * @OA\Get(
     *      path="/api/land-jamin/{property}/districts/{stateId}",
    ...
    /**
     * @OA\Get(
     *      path="/api/land-jamin/{property}/talukas/{districtId}",
    ...
    /**
     * @OA\Post(
     *      path="/api/land-jamin/{property}/amenities",
    ...
    /**
     * @OA\Post(
     *      path="/api/land-jamin/{property}/land-types",
    ...
    /**
     * @OA\Post(
     *      path="/api/land-jamin/{property}/photo-positions",
    ...
    /**
     * @OA\Delete(
     *      path="/api/land-jamin/{property}/photos/{photoIndex}",
    ...
    /**
     * @OA\Patch(
     *      path="/api/land-jamin/{property}/update-status",
